...
public class TetrisShape {
  ...
  final private Coordinate[] shapeI = { new Coordinate(0, 0), new Coordinate(1, 0), new Coordinate(-1, 0),
      new Coordinate(-2, 0) };
  final private Coordinate[] shapeL = { new Coordinate(0, 0), new Coordinate(0, 1), new Coordinate(-1, 0),
      new Coordinate(-2, 0) };
  final private Coordinate[] shapeJ = { new Coordinate(0, 0), new Coordinate(0, -1), new Coordinate(-1, 0),
      new Coordinate(-2, 0) };
  ...
  /*
   * helper method for starting point, finds the highest point so we can figure
   * out where to put it returns the height offset (positive)
   */
